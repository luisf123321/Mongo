function getFactura(){
    $.getJSON("http://localhost:8080/ProfundizacionMongo/services/Factura/list", function(result){
    	console.log(result);
...
function getDetalle(){
    $.getJSON("http://localhost:8080/ProfundizacionMongo/services/DetalleFactura/list", function(result){
    	console.log(result);
